...
export class ExperienceResolver {
  ...
  @Mutation(() => ExperienceType, { name: 'createExperience' })
  @UseGuards(AdminGuard)
  async createExperience(@Args('input') input: CreateExperienceInput) {
    return this.experienceService.create(input);
  }

  @Mutation(() => ExperienceType, { name: 'updateExperience' })
  @UseGuards(AdminGuard)
  async updateExperience(@Args('input') input: UpdateExperienceInput) {
    return this.experienceService.update(input);
  }

  @Mutation(() => Boolean, { name: 'deleteExperience' })
  @UseGuards(AdminGuard)
  async deleteExperience(@Args('id', { type: () => ID }, ParseUUIDPipe) id: string) {
