...
export default function SkillsSection({ t, skills }: SkillsSectionProps) {
  return (
    <section className="b-section" data-section="skills">
      <SectionHeader fileName="skills.json" title={t.headings.skills} />
      <div className="b-stackgrid">
        {skills.map((g) => (
          <div className="b-stackbox" key={g.category}>
