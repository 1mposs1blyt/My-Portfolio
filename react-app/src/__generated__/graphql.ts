...
export type LinkKind = "EMAIL" | "GITHUB" | "LINKEDIN" | "TELEGRAM" | "WEBSITE";

export type SkillCategory =
  "BACKEND" | "DATABASE" | "FRONTEND" | "INFRA" | "LANGUAGE" | "TOOL";

export type GetPortfolioDataQueryVariables = Exact<{ [key: string]: never }>;

export type GetPortfolioDataQuery = {
  profile: {
    name: string;
    headline: string;
    description: string;
    ...
    email: string;
    links: Array<{ kind: LinkKind; label: string; url: string; order: number }>;
    skills: Array<{
      name: string;
    ...
    experience: Array<{
      ...
      startDate: unknown;
      endDate: unknown;
      achievements: Array<{ text: string; order: number }>;
    }>;
    projects: Array<{
      id: string;
      name: string;
...
export const GetPortfolioDataDocument = {
  kind: "Document",
  definitions: [
    {
  ...
  GetPortfolioDataQueryVariables
>;
...
} as unknown as DocumentNode<GetMyProjectsQuery, GetMyProjectsQueryVariables>;
