...
type ConfirmOptions = {
  title: string;
  /** Пояснение под заголовком — например, что ещё будет удалено */
  text?: string;
  confirmLabel?: string;
  cancelLabel?: string;
...
/** await confirm({ title: "Удалить?" }) → true | false */
        ...
        >
          <div className="adm-modal-box" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="adm-modal-actions">
              ...
              <button
                ref={okRef}
                className={pending.danger ? "adm-btn adm-btn-danger" : "adm-btn adm-btn-main"}
                onClick={() => close(true)}
              >
